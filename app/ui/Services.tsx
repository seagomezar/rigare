...
const Services = () => {
    ...
    return (
      <div className="p-8">
        <h2 className="text-green-600 text-2xl mb-4">Servicios Rigare</h2>
          ...
          {services.map((service) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-between p-4 group-hover:bg-opacity-75 transition">
                <h3 className="text-white group-hover:text-yellow-500 text-lg">{service.title}</h3>
                <div className="text-right">
                  <div className="inline-block p-2 bg-yellow-600 group-hover:bg-yellow-500 transition">
                    <svg className="w-6 h-6 text-white group-hover:text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                  </div>
                </div>
              </div>
            </div>
        ...
        {selected && (
          <div className="mt-8 p-4 bg-white rounded shadow-lg">
            <h3 className="text-green-600 text-xl mb-2">{selected.title}</h3>
